public class EnerjiMüh extends Ogrenci {


    public EnerjiMüh(int ogrenciNo, String ogrenciAd, String ogrenciSoyad, String girisTarih, String fakulte, String bolum) {
    ...
    public void dersCalis() {
        System.out.println(getOgrenciAd() + " Enerji Mühendisliği derslerini çalışıyor.");
    }
