public class YazılımMüh extends Ogrenci {


    public YazılımMüh(int ogrenciNo, String ogrenciAd, String ogrenciSoyad, String girisTarih, String fakulte, String bolum) {
    ...
    public void dersCalis() {
        System.out.println(getOgrenciAd() + " Yazılım Mühendisliği derslerini çalışıyor.");
    }
